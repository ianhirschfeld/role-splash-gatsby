    ...
    <Layout>
      ...
      <div className={styles.slantedSection}>
        <div className={styles.slant}>
          <div className={`${styles.innerContent} ${styles.pillarsContent}`}>
            <h2 className={`heading1 ${styles.slantedHeading}`}>You can play with us</h2>
            <div className={styles.pillars}>
              <div className={styles.pillar}>
                <h3 className={`heading2 ${styles.pillarHeading}`}>Play Something New</h3>
              ...
              <div className={styles.pillar}>
                <h3 className={`heading2 ${styles.pillarHeading}`}>Fill Your Table</h3>
                <p className={styles.pillarBody}>
              ...
              <div className={styles.pillar}>
                <h3 className={`heading2 ${styles.pillarHeading}`}>Role Effortlessly</h3>
                <p className={styles.pillarBody}>
      ...
      <div className={styles.section}>
        <div className={`${styles.innerContent} ${styles.creatorsContent}`}>
          <h2 className={`heading1 ${styles.sectionHeading}`}>Are You a Game Creator?</h2>
      ...
      <div className={`${styles.slantedSection} ${styles.slantedSectionFooter}`}>
        <div className={styles.slant}>
          <div className={`${styles.innerContent} ${styles.pillarsContent}`}>
            <h2 className={`heading1 ${styles.slantedHeading}`}>Early Access Open Now</h2>
            ...
            <div className={`heading3 ${styles.formHeading}`}>Join the Role Community</div>
            <a
