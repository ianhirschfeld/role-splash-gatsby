        ...
        <section className={pageStyles.section}>
          ...
          <div className={pageStyles.leftContent}>
            <p>
              ...
              <strong>Creators</strong>"). The Players and Creators are both users of the Services provided by Role and
              are hereinafter referred to collectively as "<strong>Users</strong>", such services and the Role mobile
              app (the <strong>“App”</strong>), are referred to collectively in this Privacy Policy as the{' '}
            ...
            <p>
              ...
              carefully and <a href={`mailto:${email}?subject=Role%20-%20Privacy%20Contact`}>contact us</a> if you have
              any questions. By using the Service, you agree to the practices described in this Privacy Policy. If you
              do not agree to this Privacy Policy, please do not access the Site or otherwise use the Service.
            </p>
            ...
            <p>
              ...
              to identify you (“<strong>Personal Data</strong>”) as follows:
            </p>
            <p>
            ...
            <p>
              <strong>Account Data</strong>: When you create an account we will generally collect your name, email, and
              location information (if you are a User and you consent).
            </p>
            <p>
            ...
            <p>
              ...
              collect the financial information necessary to process your payments, such as your payment card number and
              authentication details. We collect certain payment and billing information needed for us to (i) pay
              Creators and (ii) accept payments from Players. This information may include billing address, payment card
              details, and, if you are a Creator, your bank account information. We collect Payment Data via secure
            ...
            <p>
              ...
              When you interact with our Social Media Pages, we will collect Personal Data that you elect to provide to
              us, such as your contact details. In addition, the companies that host our Social Media Pages may provide
              us with aggregate information and analytics regarding the use of our Social Media Pages.
            </p>
            <p>
              <strong>Personal Data We Receive Automatically From Your Use of the Service</strong>: When you visit, use,
              and interact with the Service, we may receive certain information about your visit, use, or interactions.
              For example, we may monitor the number of people that visit the Service, peak hours of visits, which
              page(s) are visited, the domains our visitors come from (e.g., google.com, yahoo.com, etc.), and which
              browsers people use to access the Service (e.g., Chrome, Firefox, Microsoft Internet Explorer, etc.),
            ...
            <p>
              ...
              (“DNT”) signals and operates as described in this Privacy Policy whether or not a DNT signal is received.
              If we do respond to DNT signals in the future, we will update this Privacy Policy to describe how we do
              so.
            </p>
            <p>
              <strong>Your Choices.</strong> On most web browsers, you will find a “help” section on the toolbar. Please
              refer to this section for information on how to receive a notification when you are receiving a new cookie
            ...
            <p>
              If you access the Site on your mobile device, you may not be able to control tracking technologies through
              the settings.
            </p>
            ...
            <p>
              ...
              of users of our Services and share aggregated information like general user statistics with prospective
              business partners. We may collect aggregated information through the Service, through cookies, and through
            ...
            <p>
              ...
              emails by following the instructions contained in each promotional email we send you. You can also control
              the marketing emails and/or text messages you receive by updating your settings through your account. In
            ...
            <p>
              ...
              Policy, while we have a business need to do so, or as required by law (e.g. for tax, legal, accounting, or
              other purposes), whichever is the longer.
            </p>
            <p>
            ...
            <p>
              <strong>Collection, Disclosure, and Use of Personal Data</strong>: The categories of Personal Data we have
              collected in the preceding twelve months are described above in the “
              <a href="#personal-data-we-collect">Personal Data We Collect</a>” section. In the preceding twelve months,
              we have disclosed for business purposes each of the categories identified in that section to the third
              parties identified in the “
              <a href="#sharing-and-disclosure-of-personal-data">Sharing and Disclosure of Personal Data</a>” sections.
              The business and commercial purposes for collecting Personal Data are described in the “
            ...
            <p>
              ...
              authorized agent, the agent must present signed written permission to act on your behalf and you may also
              be required to independently verify your identity with us. If we cannot verify your identity, we will not
              provide or delete your Personal Data.
            </p>
            <p>
            ...
            <p>
              ...
              Personal Data from children under the age of 16. If you have reason to believe that a child under the age
              of 16 has provided Personal Data to Role through the Service please{' '}
            ...
            <p>
              The Service may contain links to other websites not operated or controlled by Role, including social media
              services (“<strong>Third Party Sites</strong>”). The information that you share with Third Party Sites
              will be governed by the specific privacy policies and terms of service of the Third Party Sites and not by
            ...
            <p>
              ...
              organizational measures to protect Personal Data both online and offline from loss, misuse, and
              unauthorized access, disclosure, alteration, or destruction. However, no Internet or e-mail transmission
              is ever fully secure or error free. In particular, e-mail sent to or from us may not be secure. Therefore,
              you should take special care in deciding what information you send to us via the Service or e-mail. Please
              keep this in mind when disclosing any Personal Data to Role via the Internet. In addition, we are not
              responsible for circumvention of any privacy settings or security measures contained on the Service, or
            ...
            <p>
              ...
              Personal Data that is needed to use some features of our Service, you may be unable to use those features.
              You can also <a href={`mailto:${email}?subject=Role%20-%20Privacy%20Contact`}>contact us</a> to ask us to
              update or correct your Personal Data. You may also delete your account. Please note that we will need to
              verify that you have the authority to delete the account and certain activity generated prior to deletion
              may remain stored by us and may be shared with third parties as detailed in this Privacy Policy.
            </p>
            <p>
            ...
            <p>
              ...
              required by the applicable law. By continuing to use our Service or providing us with Personal Data after
              we have posted an updated Privacy Policy, or notified you by other means if applicable, you consent to the
