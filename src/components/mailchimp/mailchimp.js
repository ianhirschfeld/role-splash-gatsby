...
const Mailchimp = ({ isSlanted }) => {
  ...
  return (
    <div id='mc_embed_signup' className={isSlanted ? styles.slantedEmailForm : ''}>
      <form action='https://playrole.us4.list-manage.com/subscribe/post?u=e07e90c140e6a2d554c2f4a7a&amp;id=c8c46c702b' method='post' id='mc-embedded-subscribe-form' name='mc-embedded-subscribe-form' className='validate' target='_blank' noValidate>
        <div id='mc_embed_signup_scroll'>
          ...
          <div style={hiddenPositionedStyle} aria-hidden='true'><input type='text' name='b_e07e90c140e6a2d554c2f4a7a_c8c46c702b' tabIndex='-1' defaultValue='' /></div>
